...
This project formalizes the paper [A 1.30^d Lower Bound for the Chromatic Number of Euclidean Space](https://zenodo.org/records/22838037). The intended scope is
